...
SECRET_KEY = 'django-insecure-2m_oxl2(6$89&0u3cggw#i4a=xr!(xjg2!mxiz2wy=n9kmji)$'
...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware',  # for web deployment installing whitenoise
]
